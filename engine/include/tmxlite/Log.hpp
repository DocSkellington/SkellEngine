...
/*********************************************************************
This file was modified by Gaëtan Staquet to add the posibility to
choose the output
*********************************************************************/
    ...
    public:
        ...
        */
        static void log(const std::string& message, Type type = Type::Info)
        {
            ...
            if (getOutput() == Output::Console || getOutput() == Output::All)
            {
                if (type == Type::Error) {
#ifdef __ANDROID__	
            ...
            if (getOutput() == Output::File || getOutput() == Output::All)
            {
                ...
                {
                    forceLog(message, type, Output::Console);
                    forceLog("Above message was intended for log file. Opening file probably failed.", Type::Warning, Output::Console);
                }
            }
        }
